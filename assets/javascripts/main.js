!(function e(t, n, s) {
...
})(
  {
    ...
    28: [
      function (e, t, n) {
        ...
        var c = e("when"),
          ...
          C = { x: 0, y: 0 },
          k = "up",
          _ = ["presentation", "skills", "diplomes_formations", "projet", "contact"],
          L = window.innerWidth,
    ...
    54: [
      function (e, t) {
        t.exports =
          '<section id="projects">\n\n  <div class="inner">\n\n    <div class="images-container">\n      <img src="./assets/images/overview/maje.jpg" alt="">\n      <img src="./assets/images/overview/peugeot.jpg" alt="">\n      <img src="./assets/images/overview/canalsat.jpg" alt="">\n      <img src="./assets/images/overview/poiray.jpg" alt="">\n      <img src="./assets/images/overview/tignes.jpg" alt="">\n      <img src="./assets/images/overview/hermes.jpg" alt="">\n    </div>\n\n    <div class="list-container">\n\n      <ul>\n        <li> <a id="presentation" v-link="{ path: \'/projects/presentation\' }">Présentation</a> </li>\n        <li> <a id="skills" v-link="{ path: \'/projects/skills\' }">Skills</a> </li>\n        <li> <a id="diplomes_formations" v-link="{ path: \'/projects/diplomes_formations\' }">Diplômes-Formations</a> </li>\n        <li> <a id="projets" v-link="{ path: \'/projects/projets\' }">Projets</a> </li>\n        <li> <a id="contact" v-link="{ path: \'/projects/contact\' }">Contact</a> </li>\n      </ul>\n\n    </div>\n\n  </div>\n\n\n\n</section>\n';
      },
      {},
    ],
    55: [
